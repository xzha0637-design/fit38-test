...
- SQLite persists only minimal decision/follow-up records. One session-scoped,
  label-free browser snapshot of the displayed whitelisted assessment supports
